...
This repo contains different versions of the starter code for **aa08-formulate-a-response-temp**,
...
**aa08-formulate-a-response-temp**. In the directory where you want the project to appear, simply
...
```sh
git clone --branch full-time --single-branch git@github.com:appacademy/aa08-formulate-a-response-temp.git
```
...
```sh
git clone --branch part-time --single-branch git@github.com:appacademy/aa08-formulate-a-response-temp.git
```
...
`pull` changes), create a remote `aa08-formulate-a-response-temp` repo at `https://github.com`.
